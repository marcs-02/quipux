 ...
 * bajo los términos de la Licencia Pública General Affero GNU tal como
 * la publicó la Free Software Foundation, ya sea la versión 3 de la
...
<?php 
/**
 * Si el usuario que ingresa al sistema es el usuario super-administrador,
 * cargar el combo con la lista de las instituciones.
 */
if ($_SESSION["usua_codi"] == 0 || $_SESSION["admin_institucion"] == 1) {
    if (isset($_POST["inst_actu"])) {
        $inst_codi = intval($_POST["inst_actu"]);
        if ($inst_codi != 0) {
